function solve_system_symbolically()
    ...
    T0_hat_finite   = Ep_finite(AA{:}, BB{:}, LAMBDA{:}, Rth) ...
        + Em_finite(AA{:}, BB{:}, LAMBDA{:}, Rth) + Lf;
    T0_hat_infinite = Ep_infinite(AA{:}, BB{:}, LAMBDA{:}, Rth) ...
        + Em_infinite(AA{:}, BB{:}, LAMBDA{:}, Rth) + Lf;

    matlabFunction(T0_hat_finite, ...
        Vars=input_vars, ...
        Optimize=true, ...
        File='@ForwardModel/private/T0_hat_finite', ...
        Outputs="T0_hat", ...
        Comments="Created by ForwardModel.solve_system_symbolically()");
    matlabFunction(T0_hat_infinite, ...
        Vars=input_vars([1:19,21:end]), ...
        Optimize=true, ...
        File='@ForwardModel/private/T0_hat_infinite', ...
        Outputs="T0_hat", ...
        Comments="Created by ForwardModel.solve_system_symbolically()");
end